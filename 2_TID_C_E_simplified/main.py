...
workingFolder = PureWindowsPath(r"C:\Users\Ericka\Desktop\Peptide_MS\YLCAR_peptides\2_TID_C_E_simplified")  
csvFile = workingFolder / "2_TID_C_E_simplified.csv"   ##update file name to match csv name - note that it needs to be surrounded by double quotation marks
